...
class CesAuthApplicationTests {
    ...
    public static void main(String[] args) {
        ...
        gc.setAuthor("李嘉琪");
        gc.setOutputDir("D:\\MyCode\\practicaltraining\\community_electricity_supplier\\parent\\ces-auth\\src\\main\\java");
        ...
        strategy.setInclude(new String[] { "t_user","t_account" }); // 需要生成的表
...
// 包配置
        ...
        pc.setParent("com.sqds.ces.auth");
